<template>
  <div>
    <div id="Showpontos" style="width: 100%; height: 900px; position: relative;"></div>
  </div>
</template>
...
export default {
  setup() {
    ...
    const updateIframeSrc = () => {
      ...
      iframe.src = `./mapa_evento_pontos.php?deviceid=${deviceId}&data_inicial=${date1}&data_final=${date2}`;
      iframe.style.width = '100%';
      iframe.style.height = '100%';
      iframe.frameBorder = '0';

      const percursoDiv = document.getElementById('Showpontos');
