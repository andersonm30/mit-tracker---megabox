...
$sql = "SELECT online, offline, manutencao, estoque, alarmes, geocercas,desativados,
...
while($resp_kpis = mysqli_fetch_assoc($cons_kpis)){
    ...
    $desativados = ','.$resp_kpis['desativados'].$desativados;
    if( $i == 0 ){
        $i++;
        ...
        $desativados_atu = substr($desativados,1);
...
?>
        ...
        <div class="row g-4">
            <div class="col-sm-6 col-xl-2">
                <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                    <i class="fa fa-arrow-circle-up fa-3x text-success"></i>
                    <div class="ms-3">
                        <p class="mb-2"><b>Online</b></p>
                        <h6 class="mb-0 text-black-50"><?php echo $online_atu;?></h6>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xl-2">
                <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                    <i class="fa fa-arrow-circle-down fa-3x text-danger"></i>
                    <div class="ms-3">
                        <p class="mb-2"><b>Offline</b></p>
                        <h6 class="mb-0 text-black-50"><?php echo $offline_atu;?></h6>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xl-2">
                <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                    ...
                    <div class="ms-3">
                        ...
                        <h6 class="mb-0 text-black-50"><?php echo $manutencao_atu;?></h6>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xl-2">
                <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                    ...
                    <div class="ms-3">
                        ...
                        <h6 class="mb-0 text-black-50"><?php echo $estoque_atu;?></h6>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xl-2">
                <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                    ...
                    <div class="ms-3">
                        <p class="mb-2"><b>Ativos</b></p>
                        <h6 class="mb-0 text-black-50"><?php echo $estoque_atu+$manutencao_atu+$online_atu+$offline_atu;?></h6>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xl-2">
                <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                    <i class="fa fa-minus-square fa-3x text-danger"></i>
                    <div class="ms-3">
                        <p class="mb-2"><b>Desativados</b></p>
                        <h6 class="mb-0 text-black-50"><?php echo $desativados_atu;?></h6>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-6">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4 text-black-50">
                        <h6 class="mb-0 text-black-50">Status Dispositivos</h6>
                        <a href="" class="text-muted"><?php echo $data_atual; ?></a>
                    </div>
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0 text-black-50">Alertas/Geocercas</h6>
                        <a href="" class="text-muted"><?php echo $data_atual; ?></a>
                    </div>
    ...
    <div class="container-fluid pt-4 px-4">
        <div class="bg-secondary text-center rounded p-4">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <h6 class="mb-0 text-black-50">Alertas Recentes</h6>
                <a href=""></a>
            </div>
                ...
                <table class="table text-start align-middle table-bordered table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        while($resp_eventos = mysqli_fetch_assoc($cons_eventos)){
                            ...
                            $tipo = $tipo. ' '.str_replace('lowBattery','bateria baixa',str_replace('alarm:','',$attributes));
    ...
    var myChart1 = new Chart(ctx1, {
        ...
        data: {
            ...
            datasets: [{
                ...
                {
                    label: "Desativados",
                    data: [<?php echo substr($desativados,1); ?>],
                    backgroundColor: "rgba(255, 190, 190, .6)"
                }
            ]
            },
        options: {
